...
const CONTENT_CACHE = "content--2019-07-16T16:34:42+00:00--sw/";
...
const ASSET_FILES = [
  /**/ "https://res.cloudinary.com/tayloredtechnology/image/upload/c_scale,w_auto:100,dpr_auto,q_auto,f_auto,fl_progressive/v1563282615/keidrych.com/bg.jpg" /**/,
  /**/ "https://res.cloudinary.com/tayloredtechnology/image/upload/v1563282614/keidrych.com/keidrych.jpg" /**/,
  /**/
];
...
function isSameSite({ origin, pathname }) {
  return origin.startsWith("http://keidrych.com") && pathname.startsWith("");
}
